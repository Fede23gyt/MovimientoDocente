                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                          ...
                          <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                              <jet-nav-link :href="route('departamentos.index')" :active="route().current('departamentos.index')">
                                  Departamentos
                              </jet-nav-link>
                          </div>

                          <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                              <jet-nav-link :href="route('escuelas.index')" :active="route().current('escuelas.index')">
                                  Escuelas
                              </jet-nav-link>
                          </div>
                            ...
                            <jet-nav-link>
                              <jet-dropdown align="center" width="48">
                                <template #trigger>
                                        ...
                                        rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                            Configuracion
                                        </button>
